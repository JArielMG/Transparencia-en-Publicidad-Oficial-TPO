   ...
   <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
	...
	<div class="row cen-cifr" style="width:1000px;">
		...
		<div class="2u chart-wrapper dc-chart col-md-3" data-step="3"
   		...
   		<div class="2u chart-wrapper dc-chart col-md-3" data-step="4" data-intro="Presupuesto modificado<br>Muestra el presupuesto modificado (contemplando las ampliaciones y reducciones al presupuesto original, a la fecha) de los sujetos obligados usuarios de la plataforma, para la difusión en medios de comunicación y otros servicios asociados a la comunicación, de acuerdo al ejercicio seleccionado en el filtro."                              
        	style="width:215px;float: left; height:77px;" id="Ejercido"> 
	...
	<div id="barras" class="barras" data-step="5"
    	data-intro="Gráfica<br>Muestra por partida el presupuesto original, modificado y ejercido en el periodo seleccionado.">   
       	<object type="text/html" data="Sys_Screen?v=graficaPresupuesto&g=pages" style="width:100%;height:350px;"> </object>
	</div>
	<br>
   	<div class="page cen">
    	<div style="width:90%;margin:auto;" data-step="6" data-intro="En la tabla se muestra el desglose de presupuesto 
    	organizado por partida y por año, con los siguientes datos:  monto original, monto modificado, presupuesto 
    	modificado y presupuesto ejercido a la fecha.">   
	...
	<?php
    	...
    	$xcrud->column_pattern('ejercicio','{ejercicio}');
