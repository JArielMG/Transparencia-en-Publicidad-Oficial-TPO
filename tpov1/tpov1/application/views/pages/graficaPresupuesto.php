...
/**.acotaciones { float:right; margin: 0px; margin-right: 300px; } **/
	.acotaciones li{  display: inline; margin: 2px; padding: 5px; list-style: none; font-size: 0.75em; } 
	.t {width:200px !important;} 
		li.range { border: 2px solid #01AECE; background-color: #01AECE; } 
		li.marker { border: 2px solid #B0C4DE; background-color: #B0C4DE; } 
		li.measure { border: 2px solid #0836a9; background-color: #FFF ; }
...
<br>
   ...
   <div >
      <p style="text-align:center"> Coloca el cursor sobre las gráficas para conocer los detalle de la partida.</p>
   </div>

   <ul class="acotaciones cen"> 
