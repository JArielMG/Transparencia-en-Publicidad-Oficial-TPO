...
<style>
   ...
   .cen-cifr {
	...
	<div class="cen" data-step="4" data-intro="Se muestran las erogaciones del sujeto obligado por mes.">
   		<iframe src="<?php echo base_url(); ?>graphs/erogaciones/index.php" frameborder="0" scrolling="no" onload="resizeIframe(this)" style="width:90%;height:400px;" > </iframe>
	</div>

	<br><br>
	<div class="cen cen-cifr" style="width:90%;" 
    	data-step="5"
