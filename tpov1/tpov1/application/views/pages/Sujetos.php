...
<div class="container">
	...
	<div class="row cen-cifr" style="width:1000px;margin-top:50px;">
        ...
        style="width:225px;float:left;height:77px;" id="Ejercido"> 
    ...
    style="width:225px;float: left;height:77px;" id="Ejercido"> 
    	<div class="chart-title"> 
    		<strong> Sujetos obligados<br>contratantes </strong>
    	</div> 
    ...
    style="width:225px;float: left;height:77px;" id="Ejercido"> 
	    <div class="chart-title"> 
	    	<strong> Sujetos obligados<br>solicitantes </strong>
	    </div> 
    ...
    style="width:225px;float: left;height:77px;" id="Ejercido"> 
	    <div class="chart-title"> 
	    	<strong> Sujetos obligados<br>solicitantes y contratantes </strong>
	    </div> 
    ...
    <div  
        data-step="4"
        data-intro="Muestra los  sujetos obligados 	que hayan ejercido recursos en publicidad oficial, al periodo seleccionado."> 
        <iframe src="<?php echo base_url(); ?>graphs/treemap2/index.php?f=so.json" frameborder="0" scrolling=auto style="width:100%;height:555px;" >  </iframe>
	</div>
	
	<br><br><br><br>
	<div class="cen-cifr cen" style="width:90%;" data-step="5"
    ...
    <h2>Detalle de sujetos obligados</h2>
    <br>
